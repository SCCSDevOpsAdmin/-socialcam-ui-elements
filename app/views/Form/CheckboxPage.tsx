            ...
            <div className="card">
                ...
                <div className="field-checkbox">
                    <Checkbox
                        ...
                        value="Los Angeles"
                        onChange={onCityChange}
                        checked={cities.indexOf('Los Angeles') !== -1}
                    />
                ...
                <div className="field-checkbox">
                    <Checkbox
                        ...
                        value="New York"
                        onChange={onCityChange}
                        checked={cities.indexOf('New York') !== -1}
                    />
                ...
                <div className="field-checkbox">
                    <Checkbox
                        ...
                        value="San Francisco"
                        onChange={onCityChange}
                        checked={cities.indexOf('San Francisco') !== -1}
                    />
                    <label htmlFor="city4">San Francisco</label>
                </div>

                <h5>
                    Dynamic Values, Preselection, Value Binding and Disabled
                    Option
                </h5>
