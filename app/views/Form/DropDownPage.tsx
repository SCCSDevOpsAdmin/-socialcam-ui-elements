...
import { DropdownDateSelection } from 'src/components/dateselection/DropdownDateSelection';
...
const DropDownPage = (props: Props) => {
    ...
    const cities = [
        {
            name: 'New York New YorkNew YorkNew YorkNew YorkNew YorkNew YorkNew YorkNew York',
            code: 'NY',
        },
        { name: 'Rome', code: 'RM' },
    ...
    const onGroupedCityChange = (e: any) => {
    ...
    return (
        <div className="dropdown-demo">
            ...
            <div className="card">
                ...
                />*/}
                <br />
                <div style={{ height: '800px' }}>Sample to Overflow</div>
            </div>
        </div>
    );
};
