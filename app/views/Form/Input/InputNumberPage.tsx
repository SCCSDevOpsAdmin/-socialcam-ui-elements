...
import { InputNumber } from 'src/elements';
        ...
        <div>
            <div className="content-section introduction">
                <div className="feature-intro">
                    <h1>InputNumber</h1>
                    <p>
                        InputNumber is an input component to provide numerical
                        input.
                    </p>
                </div>
            </div>
            ...
            <div className="content-section implementation">
                <div className="card">
                    <h5>Numerals</h5>
                    <div className="cs-fluid grid formgrid">
                    ...
                    <div className="grid cs-fluid">
                        ...
                        <div className="field col-12 md:col-3">
                            ...
                            <InputNumber
                                ...
                                step={0.25}
                                decrementButtonClassName="cs-button-danger"
                                incrementButtonClassName="cs-button-success"
