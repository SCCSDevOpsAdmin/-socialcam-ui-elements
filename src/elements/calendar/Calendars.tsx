...
//import CsReact, { localeOption, localeOptions } from '../../api/Api';
...
//import { CalendarChangeParams, CalendarProps } from './types';
//import './Calendar.scss';

//export const Calendar = React.memo(
//    React.forwardRef((props: CalendarProps | any, ref) => {
//        props = ObjectUtils.initProps(props, defaultProps);

//        const [focusedState, setFocusedState] = React.useState(false);
//        const [overlayVisibleState, setOverlayVisibleState] =
//            React.useState(false);
//        const [viewDateState, setViewDateState] = React.useState<any>(null);
...
//        const timePickerTimer = React.useRef<any>(null);
//        const viewStateChanged = React.useRef(false);
//        const touchUIMask = React.useRef<any>(null);
//        const overlayEventListener = React.useRef<any>(null);
//        const touchUIMaskClickListener = React.useRef<any>(null);
//        const isOverlayClicked = React.useRef(false);

//        const [currentView, setCurrentView] = React.useState('date');
//        const [currentMonth, setCurrentMonth] = React.useState<any>(null);
//        const [currentYear, setCurrentYear] = React.useState<any>(null);
...
//        const updateValueOnInput = (event: any, rawValue: any) => {
//            try {
...
//        const isValidSelection = (value: any) => {
//            let isValid = true;
...
//                            overlayRef.current,
//                            '.cs-datepicker-calendar td span:not(.cs-disabled)'
//                        );
...
//                    overlayRef.current,
//                    '.cs-monthpicker .cs-monthpicker-month'
//                );
//                const selectedCell = DomHandler.findSingle(
//                    overlayRef.current,
//                    '.cs-monthpicker .cs-monthpicker-month.cs-highlight'
//                );
...
//                        overlayRef.current,
//                        'td.cs-datepicker-today span:not(.cs-disabled)'
//                    );
//                    cell =
//                        todayCell ||
//                        DomHandler.findSingle(
...
//                    setCurrentMonth((prevState: any) => prevState - 1);
//                }
...
//        const populateYearOptions = (start: number, end: number) => {
//            let _yearOptions: number[] = [];
...
//        const onMonthDropdownChange = (event: any, value: any) => {
...
//        const onYearDropdownChange = (event: any, value: any) => {
//            const currentViewDate = getViewDate();
//            let newViewDate = new Date(currentViewDate.getTime());
...
//        const onTodayButtonClick = (event: any) => {
...
//        const onPanelMouseUp = (event: any) => {
//            onPanelClick(event);
//        };

//        const onTimePickerElementMouseDown = (
//            event: any,
//            type: any,
//            direction: any
//        ) => {
...
//        const doStepMinute = (currentMinute: number, step: number) => {
...
//        const incrementMinute = (event: any) => {
//            const currentTime = getCurrentDateTime();
...
//        const decrementMinute = (event: any) => {
//            const currentTime = getCurrentDateTime();
//            const currentMinute = currentTime.getMinutes();
//            let newMinute = doStepMinute(currentMinute, -props.stepMinute);
...
//        const incrementSecond = (event: any) => {
//            const currentTime = getCurrentDateTime();
...
//        const decrementSecond = (event: any) => {
//            const currentTime = getCurrentDateTime();
//            const currentSecond = currentTime.getSeconds();
//            let newSecond = currentSecond - props.stepSecond;
...
//        const incrementMilliSecond = (event: any) => {
//            const currentTime = getCurrentDateTime();
...
//        const decrementMilliSecond = (event: any) => {
//            const currentTime = getCurrentDateTime();
//            const currentMillisecond = currentTime.getMilliseconds();
//            let newMillisecond = currentMillisecond - props.stepMillisec;
//            newMillisecond =
...
//        const validateHour = (hour: any, value: any) => {
//            let valid = true;
...
//        const validateMinute = (minute: number, value: Date) => {
//            let valid = true;
//            let valueDateString = value ? value.toDateString() : null;
...
//        const validateSecond = (second: any, value: any) => {
//            let valid = true;
//            let valueDateString = value ? value.toDateString() : null;
...
//        const validateMillisecond = (millisecond: number, value: Date) => {
//            let valid = true;
//            let valueDateString = value ? value.toDateString() : null;
...
//        const onDateCellKeydown = (event: any, date: any, groupIndex: any) => {
...
//                        if (DomHandler.hasClass(focusCell, 'cs-disabled')) {
//                            navigation.current = { backward: false };
//                            navForward(event);
//                        } else {
//                            nextRow.children[cellIndex].children[0].tabIndex =
//                                '0';
...
//        const navigateToMonth = (prev: any, groupIndex: any, event: any) => {
//            if (prev) {
...
//        const onMonthCellKeydown = (event: any, index: any) => {
...
//        const onDateSelect = (event: any, dateMeta: any, timeMeta?: any) => {
...
//                    let value = props.value.filter((date: any) => {
...
//        const selectTime = (date: any, timeMeta: any) => {
//            if (props.showTime) {
...
//        const selectDate = (event: any, dateMeta: any, timeMeta: any) => {
...
//            setCurrentYear((prevState: number) => prevState - 10);
//        };
...
//        const onMonthSelect = (event: any, month: any) => {
//            if (props.view === 'month') {
//                onDateSelect(event, {
//                    year: currentYear,
//                    month: month,
...
//        const onYearSelect = (event: any, year: any) => {
//            if (props.view === 'year') {
//                onDateSelect(event, {
//                    year: year,
//                    month: 0,
...
//                overlayEventListener.current = (e: any) => {
...
//        const hide = (type?: any, callback?: any) => {
//            const _hideCallback = () => {
...
//                    overlayRef.current,
//                    CsReact.autoZIndex,
//                    props.baseZIndex || CsReact.zIndex[key]
//                );
//            }
...
//                    touchUIMask.current,
//                    'cs-component-overlay cs-datepicker-mask cs-datepicker-mask-scrollblocker cs-component-overlay-enter'
//                );
...
//                    DomHandler.hasClass(
//                        bodyChild,
//                        'cs-datepicker-mask-scrollblocker'
//                    )
//                ) {
...
//        const isNavIconClicked = (target: any) => {
//            return (
//                DomHandler.hasClass(target, 'cs-datepicker-prev') ||
//                DomHandler.hasClass(target, 'cs-datepicker-prev-icon') ||
//                DomHandler.hasClass(target, 'cs-datepicker-next') ||
//                DomHandler.hasClass(target, 'cs-datepicker-next-icon')
//            );
//        };
...
//        const createMonthsMeta = (month: any, year: any) => {
//            let months = [];
...
//        const createMonthMeta = (month: any, year: any) => {
//            let dates = [];
...
//        const isSelectableTime = (value: any) => {
//            let validMin = true;
//            let validMax = true;
...
//        const isMonthSelected = (month: any) => {
//            if (isComparable()) {
...
//        const isDateBetween = (start: any, end: any, dateMeta: any) => {
//            let between = false;
//            if (start && end) {
//                let date = new Date(
//                    dateMeta.year,
...
//        const updateInputfield = (value: any) => {
//            if (!inputRef.current) {
//                return;
//            }
...
//                try {
//                    if (isSingleSelection()) {
//                        let valid = isValidDate(value);
//                        formattedValue = valid ? formatDateTime(value) : '';
//                    } else if (isMultipleSelection()) {
...
//        const parseValueFromString = (text: string) => {
...
//        const populateTime = (value: any, timeString: any, ampm: any) => {
...
//        const parseTime = (value: any, ampm: any) => {
...
//                (props.showSeconds && (Number.isNaN(s) || (s && s > 59))) ||
//                (props.showMillisec && (Number.isNaN(s) || (s && s > 1000)))
//            ) {
//                throw new Error('Invalid time');
//            } else {
...
//        const parseDate = (value: any, format: any) => {
...
//        const isInMinYear = (viewDate: any) => {
//            return (
//                props.minDate &&
...
//        const isInMaxYear = (viewDate: any) => {
//            return (
//                props.maxDate &&
...
//        const createBackwardNavigator = (isVisible: any) => {
//            const navigatorProps: any = isVisible
//                ? {
//                      onClick: onPrevButtonClick,
//                      onKeyDown: (e: any) => onContainerButtonKeydown(e),
//                  }
//                : { style: { visibility: 'hidden' } };
//            return (
//                <button
//                    type="button"
//                    className="cs-datepicker-prev"
//                    {...navigatorProps}
//                >
//                    <span className="cs-datepicker-prev-icon csi csi-chevron-left"></span>
//                    {/*<Ripple />*/}
//                </button>
//            );
//        };

//        const createForwardNavigator = (isVisible: any) => {
//            const navigatorProps: any = isVisible
//                ? {
...
//                <button
//                    type="button"
//                    className="cs-datepicker-next"
//                    {...navigatorProps}
//                >
//                    <span className="cs-datepicker-next-icon csi csi-chevron-right"></span>
//                    {/*<Ripple />*/}
//                </button>
//            );
//        };

//        const createTitleMonthElement = (monthMetadata?: any) => {
...
//                const content = (
//                    <select
//                        className="cs-datepicker-month"
//                        onChange={(e) => {
//                            onMonthDropdownChange(e, e.target.value);
//                        }}
//                        value={viewMonth}
//                    >
//                        {displayedMonthOptions.map((option: any) => (
...
//                currentView === 'date' && (
//                    <button
//                        className="cs-datepicker-month cs-link"
...
//                currentView !== 'year' && (
//                    <button
//                        className="cs-datepicker-year cs-link"
...
//            if (currentView === 'year') {
//                return (
//                    <span className="cs-datepicker-decade">
...
//            return (
//                <div className="cs-datepicker-title">
//                    {month}
//                    {year}
//                    {decade}
//                </div>
...
//                        scope="col"
//                        key="wn"
//                        className="cs-datepicker-weekheader cs-disabled"
//                    >
...
//                    'cs-datepicker-other-month': date.otherMonth,
//                    'cs-datepicker-today': date.today,
//                });
//                const dateClassName = classNames({
//                    'cs-highlight': selected,
//                    'cs-disabled': !date.selectable,
//                });
//                const content =
...
//                    <td
//                        key={'wn' + weekNumber}
//                        className="cs-datepicker-weeknumber"
//                    >
//                        <span className="cs-disabled">{weekNumber}</span>
//                    </td>
//                );
...
//        const createDates = (monthMetaData: any, groupIndex: any) => {
//            return monthMetaData.dates.map((weekDates: any, index: any) => (
//                <tr key={index}>
//                    {createWeek(
//                        weekDates,
...
//            return (
//                currentView === 'date' && (
//                    <div className="cs-datepicker-calendar-container">
//                        <table className="cs-datepicker-calendar">
//                            <thead>
//                                <tr>{dayNames}</tr>
//                            </thead>
//                            <tbody>{dates}</tbody>
...
//        const createMonth = (monthMetaData: any, index: any) => {
...
//            return (
//                <div key={monthMetaData.month} className="cs-datepicker-group">
...
//            return (
//                <div className="cs-datepicker-group-container">{groups}</div>
//            );
//        };
...
//        const createMonthViewMonth = (index: any) => {
//            const className = classNames('cs-monthpicker-month', {
//                'cs-highlight': isMonthSelected(index),
//            });
...
//            return (
//                <>
//                    <div className="cs-datepicker-group-container">
//                        <div className="cs-datepicker-group">
//                            <div className="cs-datepicker-header">
//                                {backwardNavigator}
//                                <div className="cs-datepicker-title">
//                                    {yearElement}
...
//                        onKeyDown={(e) => onContainerButtonKeydown(e)}
//                    >
//                        <span className="csi csi-chevron-down"></span>
//                        {/*<Ripple />*/}
//                    </button>
//                </div>
//            );
...
//            return (
//                <div className="cs-minute-picker">
//                    <button
//                        type="button"
//                        className="cs-link"
//                        onMouseDown={(e) =>
//                            onTimePickerElementMouseDown(e, 1, 1)
//                        }
//                        onMouseUp={onTimePickerElementMouseUp}
//                        onMouseLeave={onTimePickerElementMouseLeave}
//                        onKeyDown={(e) => onContainerButtonKeydown(e)}
...
//                return (
//                    <div className="cs-second-picker">
//                        <button
//                            type="button"
//                            className="cs-link"
//                            onMouseDown={(e) =>
...
//                return (
//                    <div className="cs-millisecond-picker">
//                        <button
//                            type="button"
//                            className="cs-link"
//                            onMouseDown={(e) =>
...
//        const createSeparator = (separator: any) => {
//            return (
...
//                        tabIndex="-1"
//                        disabled={props.disabled}
//                        className="cs-datepicker-trigger"
//                    />
//                );
//            }
...
//                return (
//                    <div className="cs-datepicker-buttonbar">
//                        <Button
//                            type="button"
//                            label={today}
...
//                return <div className="cs-datepicker-footer">{content}</div>;
//            }
...
//                                        'cs-monthpicker-month',
//                                        { 'cs-highlight': isMonthSelected(i) }
//                                    )}
//                                >
//                                    {m}
//                                </span>
...
//            'cs-calendar cs-component cs-inputwrapper',
//            props.className,
//            {
//                [`cs-calendar-w-btn cs-calendar-w-btn-${props.iconPos}`]:
//                    props.showIcon,
//                'cs-calendar-disabled': props.disabled,
//                'cs-calendar-timeonly': props.timeOnly,
//                'cs-inputwrapper-filled':
//                    props.value ||
//                    (DomHandler.hasClass(inputRef.current, 'cs-filled') &&
//                        inputRef.current.value !== ''),
//                'cs-inputwrapper-focus': focusedState,
//            }
//        );
//        const panelClassName = classNames(
//            'cs-datepicker cs-component',
//            props.panelClassName,
//            {
//                'cs-datepicker-inline': props.inline,
//                'cs-disabled': props.disabled,
//                'cs-datepicker-timeonly': props.timeOnly,
//                'cs-datepicker-multiple-month': props.numberOfMonths > 1,
//                'cs-datepicker-monthpicker': currentView === 'month',
//                'cs-datepicker-touch-ui': props.touchUI,
//            }
//        );
...
//    showButtonBar: false,
//    todayButtonClassName: 'cs-button-secondary',
//    clearButtonClassName: 'cs-button-secondary',
//    autoZIndex: true,
//    baseZIndex: 0,
//    //appendTo: null,
//    //tooltip: null,
