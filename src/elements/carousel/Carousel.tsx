...
import CsReact, { CsIcons } from '../../api/Api';
import {
    useMountEffect,
    usePrevious,
    useResizeListener,
...
import { ariaLabel } from 'src/api/Locale';

const CarouselItem = React.memo((props: CarouselItemProps) => {
    const content = props.template(props.item);
    const className = classNames(props.className, 'cs-carousel-item', {
        'cs-carousel-item-active': props.active,
        'cs-carousel-item-start': props.start,
        'cs-carousel-item-end': props.end,
    });
...
export const Carousel = React.memo(
    React.forwardRef((props: CarouselProps, ref?) => {
        ...
        const [bindWindowResizeListener] = useResizeListener({
            ...
            when:
                props.responsiveOptions != undefined &&
                props.responsiveOptions !== null,
        });
        ...
        const navBackward = (e, page?: number) => {
        ...
        const navForward = (e, page?: number) => {
        ...
        const createStyle = () => {
            ...
            let innerHTML = `
            .cs-carousel[${attributeSelector.current}] .cs-carousel-item {
        ...
        `;
            ...
            if (props.responsiveOptions) {
                ...
                responsiveOptions.current.sort((data1, data2) => {
                    ...
                    return ObjectUtils.sort(value1, value2, -1, CsReact.locale);
                });
                    ...
                    clonedItemsForStarting = clonedElements.map(
                        (item, index) => {
                            ...
                            return (
                                <CarouselItem
                                    key={key}
                                    className="cs-carousel-item-cloned"
        ...
        const createHeader = () => {
            if (props.header) {
                return <div className="cs-carousel-header">{props.header}</div>;
            }
        ...
        const createFooter = () => {
            if (props.footer) {
                return <div className="cs-carousel-footer">{props.footer}</div>;
            }
        ...
        const createContent = () => {
            ...
            return (
                <div className={className}>
                    {backwardNavigator}
                    <div
                        className="cs-carousel-items-content"
                        style={{ height: height }}
                    ...
                    >
                        <div
                            ...
                            className="cs-carousel-items-container"
                ...
                const isDisabled =
                    (!circular ||
                        (props.value &&
                            props.value.length < numVisibleState)) &&
                    currentPage === 0;
                const className = classNames('cs-carousel-prev cs-link', {
                    'cs-disabled': isDisabled,
                });
                const iconClassName = 'cs-carousel-prev-icon';
                const icon = isVertical
                    ? props.prevIcon || CsIcons.ARROW_UP
                    : props.prevIcon || CsIcons.ARROW_LEFT;
            ...
            if (props.showNavigators) {
                const isDisabled =
                    ...
                    (currentPage === totalIndicators - 1 ||
                        totalIndicators === 0);
                const className = classNames('cs-carousel-next cs-link', {
                    'cs-disabled': isDisabled,
                });
                const iconClassName = 'cs-carousel-next-icon';
                const icon = isVertical
                    ? props.nextIcon || CsIcons.ARROW_DOWN
                    : props.nextIcon || CsIcons.ARROW_RIGHT;
        ...
        const createIndicator = (index) => {
            ...
            const className = classNames('cs-carousel-indicator', {
                'cs-highlight': isActive,
            });
        ...
        const createIndicators = () => {
            if (props.showIndicators) {
                const className = classNames(
                    'cs-carousel-indicators cs-reset',
        ...
        const className = classNames(
            'cs-carousel cs-component',
            {
                'cs-carousel-vertical': isVertical,
                'cs-carousel-horizontal': !isVertical,
            },
            props.className
        );
