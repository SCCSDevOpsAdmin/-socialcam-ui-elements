...
type ColumnFilterMatchModeType =
    | 'startsWith'
    | 'contains'
    | 'endsWith'
    | 'equals'
...
interface ColumnFilterConstraintRemoveParams
    extends ColumnFilterConstraintAddParams {}
