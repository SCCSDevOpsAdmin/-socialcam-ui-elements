...
import { ObjectUtils, classNames } from 'src/utils/Utils';
import './DataScroller.scss';
import { DataScrollerProps } from './types';

export const DataScroller = React.memo(
    React.forwardRef((props: DataScrollerProps, ref) => {
        ...
        const createHeader = () => {
            if (props.header) {
                return (
                    <div className="cs-datascroller-header">{props.header}</div>
                );
            }
        ...
        const createFooter = () => {
            if (props.footer) {
                return (
                    <div className="cs-datascroller-footer">{props.footer}</div>
                );
            }
        ...
        const createContent = () => {
            ...
            return (
                <div
                    ref={contentRef}
                    className="cs-datascroller-content"
                    style={{ maxHeight: props.scrollHeight }}
                >
                    <ul className="cs-datascroller-list">{content}</ul>
                </div>
            );
        };
        ...
        const className = classNames(
            'cs-datascroller cs-component',
            props.className,
            {
                'cs-datascroller-inline': props.inline,
            }
        );
