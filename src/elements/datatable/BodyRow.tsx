...
export const BodyRow = React.memo((props: any) => {
    ...
    const findNextSelectableRow = (row) => {
        ...
        return nextRow
            ? DomHandler.hasClass(nextRow, 'cs-selectable-row')
                ? nextRow
    ...
    const findPrevSelectableRow = (row) => {
        ...
        return prevRow
            ? DomHandler.hasClass(prevRow, 'cs-selectable-row')
                ? prevRow
    ...
    const className = classNames(rowClassName, {
        'cs-highlight': !props.allowCellSelection && props.selected,
        'cs-highlight-contextmenu': props.contextMenuSelected,
        'cs-selectable-row':
            props.allowRowSelection &&
            props.isSelectable({ data: props.rowData, index: props.index }),
        'cs-row-odd': props.index % 2 !== 0,
    });
    const style = {
