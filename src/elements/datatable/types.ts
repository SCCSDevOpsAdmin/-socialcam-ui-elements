...
import { PaginatorTemplate } from '../paginator/types';
import { VirtualScrollerProps } from '../virtualscroller/types';

type DataTableHeaderTemplateType =
    | React.ReactNode
    | ((options: DataTableHeaderTemplateOptions) => React.ReactNode);

type DataTableFooterTemplateType =
    | React.ReactNode
    | ((options: DataTableFooterTemplateOptions) => React.ReactNode);
...
interface DataTableFooterTemplateOptions
    extends DataTableHeaderTemplateOptions {}
...
interface DataTableRowGroupFooterTemplateOptions
    extends DataTableRowGroupHeaderTemplateOptions {
    colSpan: number;
}
...
export interface DataTableSelectionChangeParams {
...
interface DataTableRowClickEventParams
    extends Omit<DataTableRowEventParams, 'originalEvent'> {
    originalEvent: React.MouseEvent<HTMLElement>;
    index: number;
}
...
export interface DataTableProps
    ...
    cellClassName?(
        value: any,
        options: DataTableCellClassNameOptions
    ): object | string;
    ...
    rowEditValidator?(
        data: any,
        options: DataTableRowEditValidatorOptions
    ): boolean;
...
export declare class DataTable extends React.Component<DataTableProps, any> {
    ...
    public filter<T>(
        value: T,
        field: string,
        mode: DataTableFilterMatchModeType,
        index?: number
    ): void;
