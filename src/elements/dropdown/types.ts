...
type DropdownOptionGroupTemplateType =
    | React.ReactNode
    | ((option: any, index: number) => React.ReactNode);

type DropdownValueTemplateType =
    | React.ReactNode
    | ((option: any, props: DropdownProps) => React.ReactNode);

type DropdownItemTemplateType =
    | React.ReactNode
    | ((option: any) => React.ReactNode);

type DropdownEmptyMessageType =
    | React.ReactNode
    | ((props: DropdownProps) => React.ReactNode);

type DropdownEmptyFilterMessageType =
    | React.ReactNode
    | ((props: DropdownProps) => React.ReactNode);
