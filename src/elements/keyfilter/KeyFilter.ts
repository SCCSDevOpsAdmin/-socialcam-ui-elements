...
export const KeyFilter = {
    ...
    isNavKeyPress(e) {
        ...
        return (
            (k >= 33 && k <= 40) ||
            k === KeyFilter.KEYS.RETURN ||
            k === KeyFilter.KEYS.TAB ||
            k === KeyFilter.KEYS.ESC
        );
    },
    ...
    getKey(e) {
        ...
        return DomHandler.getBrowser().safari
            ? KeyFilter.SAFARI_KEYS[k] || k
            : k;
    },
    ...
    onKeyPress(e, keyfilter, validateOnly) {
        ...
        if (
            ...
            (this.isNavKeyPress(e) ||
                k === KeyFilter.KEYS.BACKSPACE ||
                (k === KeyFilter.KEYS.DELETE && e.charCode === 0))
        ) {
            return;
        }
