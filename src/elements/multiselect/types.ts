...
type MultiSelectOptionGroupTemplateType =
    | React.ReactNode
    | ((option: any, index: number) => React.ReactNode);

type MultiSelectItemTemplateType =
    | React.ReactNode
    | ((option: any) => React.ReactNode);

type MultiSelectSelectedItemTemplateType =
    | React.ReactNode
    | ((value: any) => React.ReactNode);

type MultiSelectEmptyFilterMessageType =
    | React.ReactNode
...
type MultiSelectPanelHeaderTemplateType =
    | React.ReactNode
    | ((e: MultiSelectPanelHeaderTemplateParams) => React.ReactNode);

type MultiSelectPanelFooterTemplateType =
    | React.ReactNode
