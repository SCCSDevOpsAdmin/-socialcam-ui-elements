...
export const Tooltip = React.memo(
    React.forwardRef((props: TooltipProps, ref) => {
        ...
        const align = (target, coordinate?, position?) => {
            ...
            if (
                ...
                let { top: mouseTrackTop, left: mouseTrackLeft } =
                ...
                DomHandler.addClass(elementRef.current, 'cs-tooltip-active');
            } else {
            ...
            if (target) {
                if (DomHandler.isElement(target)) {
                    ...
                    const setEvent = (target) => {
                        let el = document.firstElementChild as HTMLElement;
                        let element = DomHandler.find(el, target);
        ...
        const createElement = () => {
            ...
            const tooltipClassName = classNames(
                'cs-tooltip cs-component',
                {
                    [`cs-tooltip-${positionState}`]: true,
                },
                props.className,
                classNameState
            );
            ...
            return (
                ...
                >
                    ...
                    <div ref={textRef} className="cs-tooltip-text">
...
const defaultProps = {
    ...
    id: null,
    mouseTrack: false, //essential for tooltip to work
    mouseTrackLeft: 5,
    mouseTrackTop: 5,
    my: null,
    onBeforeHide: null,
