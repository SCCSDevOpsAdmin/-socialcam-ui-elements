...
type TreeHeaderTemplateType =
    | React.ReactNode
    | ((options: TreeHeaderTemplateOptions) => React.ReactNode);

type TreeFilterTemplateType =
    | React.ReactNode
    | ((options: TreeFilterOptions) => React.ReactNode);

type TreeFooterTemplateType =
    | React.ReactNode
    | ((props: TreeProps) => React.ReactNode);

type TreeNodeTemplateType =
    | React.ReactNode
    | ((node: TreeNode, options: TreeNodeTemplateOptions) => React.ReactNode);

type TreeTogglerTemplateType =
    | React.ReactNode
    | ((
          node: TreeNode,
